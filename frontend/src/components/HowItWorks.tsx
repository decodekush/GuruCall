...
const steps = [
  {
    ...
    description: 'Dial the GuruCall number from any phone — mobile, landline, or smartphone.',
    color: 'primary',
  ...
  },
  {
    ...
    icon: Brain,
    title: 'AI Processing',
    description: 'Groq\'s Llama 3.3 70B analyzes your question and generates a curriculum-aligned explanation.',
    color: 'amber',
